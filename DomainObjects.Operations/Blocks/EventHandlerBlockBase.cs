namespace DomainObjects.Operations
{
    ...
    {
        internal class EventHandlerBlockBase : StackBlockBase, IResultVoidDispatcher<TState>
        {
            readonly ResultVoidDispatcher<TState> resultDispather = new ResultVoidDispatcher<TState>();
            public EventHandlerBlockBase(string tag, TInput stackInput, TState state, IStackEvents stackEvents)
