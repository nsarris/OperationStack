namespace DomainObjects.Operations
{
    ...
    {
        internal class EventHandlerBlockBase<Tin> : StackBlockBase, IStackBlock<TInput, TState, Tin>, IResultDispatcher<Tin, TState>
        {
            readonly ResultDispatcher<Tin, TState> resultDispather = new ResultDispatcher<Tin, TState>();
            internal EventHandlerBlockBase(string tag, TInput stackInput, TState state, Emptyable<Tin> input, IStackEvents stackEvents)
